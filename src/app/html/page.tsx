    ...
    <main className={styles.main}>
      ...
      <section className={styles.descriptionSection}>
        ...
        <>
          ...
          <ul>
            <li>
              <strong>Divs</strong> – General-purpose containers used to group
              or structure content. They act like empty boxes you can style or
              organize.
            </li>
            <br />
            <li>
            ...
            <br />
            <li>
              <strong>Links</strong> – Create navigation between pages or
              external sites.
            </li>
            <br />
            <li>
          ...
          <ul>
            ...
            <br />
            <li>
              <strong>"article"</strong> – A self-contained piece of content,
              like a post or card.
            </li>
            <br />
            <li>
          ...
          <p>
            ...
            accessibility for assistive technology, and provides better
...
`}
          ...
          >
            When combined with CSS and JavaScript, HTML becomes the foundation
            for all modern web experiences:
          </p>
          <br />
          <ul>
          ...
          <br />
          <p>
            Understanding these basics helps beginners make sense of how
            websites are built and how each layer works together.
          </p>
        </>
      </section>
    </main>
